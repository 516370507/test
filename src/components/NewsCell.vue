    ...
    <section class="collect" @click="jumpPage">
      <aside>
        ...
        <section class="Cleft clearfix">
          <img class="f1" src="" style="width: 0.24rem; height: 0.2rem;" alt="">
          <span class="f1">{{newsDate.author_name}}</span>
        </section>
        <section class="Cright">
          <img src="" style="width: 0.2rem; height: 0.2rem;" alt="">
          <span>{{newsDate.date | getYMD}}</span>
        </section>
        <div style="clear: both"></div>
      </aside>
      <aside>
        <img src="newsDate.thumbnail_pic_s" style="border-radius: 0.2rem;" alt="">
      </aside>
      <div style="clear: both"></div>
    </section>
  </section>
